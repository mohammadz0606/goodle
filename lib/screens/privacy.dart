...
class PrivacyScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSizedBoxTitleAndTitle(),
            _buildOptions(context, optionText: "Google Play Services"),
            _buildOptions(context, optionText: "AdMob"),
            _buildOptions(context, optionText: "One Signal"),
            _buildSizedBoxTitleAndTitle(),
            ...
            _buildTextBody(
              context,
              text:
                  "If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at goodlecontacts@gmail.com.\nThis privacy policy page was created at privacypolicytemplate.net and modified/generated by App Privacy Policy Generator",
            ),
          ],
        ),
      ),
  ...
  Padding _buildOptions(BuildContext context, {required String optionText}) {
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10.w),
          Expanded(
            child: _buildTextBody(context, text: optionText),
          ),
        ],
      ),
    );
  ...
  Text _buildTextBody(BuildContext context, {required String text}) {
    return Text(
      text,
  ...
  Text _buildTextTitle(BuildContext context, {required String text}) {
    return Text(
      text,
      style: Theme.of(context).textTheme.bodyLarge!.copyWith(
